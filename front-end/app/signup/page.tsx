...
export default function SignupPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-[800px] h-[800px] bg-accent/5 rounded-full blur-3xl -translate-y-1/2 -translate-x-1/3 pointer-events-none" />
            <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-primary/5 rounded-full blur-3xl translate-y-1/3 translate-x-1/4 pointer-events-none" />
            ...
            >
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-3xl font-bold text-foreground mb-3">Create an account</h1>
                    <p className="text-muted-foreground">Join Marcos AI for modern insurance brokering</p>
                </div>
